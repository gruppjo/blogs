...
"Functional programmig rocks"
"Just sit there like a rock doing nothing".
Mutability unexpected changes.

Challenges (copy wastes time & space) and the magic behind hash array mapped tries that make immutable data structures really fast.

mori (more functional/lisp-like interface), immutable js (facebook, oo like)
